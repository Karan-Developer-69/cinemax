    ...
    return (
        <div className="min-h-screen pt-20 flex items-center justify-center p-6 relative overflow-hidden bg-primary-bg">
            ...
            <div className="w-full max-w-md glass-light border border-border-color rounded-3xl p-8 md:p-10 relative z-10 shadow-2xl animate-fade-in-up">
                ...
                <h2 className="text-3xl font-extrabold text-center mb-2 tracking-tight text-text-primary">Welcome Back</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <a href="#" className="text-xs font-semibold text-accent-gold hover:text-text-primary transition-colors">Forgot Password?</a>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-text-secondary">
                                <Lock size={18} />
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3.5 mt-4 bg-text-primary text-primary-bg font-extrabold rounded-xl hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:scale-[1.02] transition-all disabled:opacity-70 disabled:hover:scale-100 disabled:cursor-not-allowed"
                    >
                ...
                <div className="mt-8 text-center text-sm font-medium text-text-secondary">
                    ...
                    <Link to="/signup" className="text-text-primary hover:text-accent-gold font-bold transition-colors">
                        Create account
                    </Link>
                </div>
            </div>
